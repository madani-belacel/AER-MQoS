...
- Fichier généré : `aer-real-25-hybrid-20260512.csc`
- Générateur : `gen_csc_hybrid25.py` (graine **20260512**, reproductible)
...
Remplacer `RPL_STD` par l’étiquette de campagne (ex. `MQoS`, `AER`, `AER_MQOS`) selon la variante, puis ouvrir le `.csc` dans Cooja, lancer la simulation et exporter la console / *Log listener* vers `logs/<tag>_seed20260512.txt`.

## Régénérer le .csc

```text
python3 gen_csc_hybrid25.py --out aer-real-25-hybrid-20260512.csc
```
