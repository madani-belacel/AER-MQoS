...
<simconf>
  <simulation>
    <title>Hybrid Cooja campaign — 25 motes hybrid seed=20260501 sr_tx=0.85 sr_rx=0.85 | ScriptRunner TIMEOUT=180000 ms sim time</title>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>TIMEOUT(180000, log.testOK());
