#ifndef AER_MQOS_STACK_H_
#define AER_MQOS_STACK_H_
/*
 * Copyright (c) 2026, Madani Belacel.
 * Public API: MCS, traffic classes C0..C3, context weights.
 */
...
const char *aer_domain_to_str(aer_domain_t d);
