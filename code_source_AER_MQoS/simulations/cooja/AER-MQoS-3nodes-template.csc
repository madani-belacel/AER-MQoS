...
<simconf>
  <simulation>
    <title>AER-MQoS Cooja template (3 motes, UDGM) — PROTO=AER_MQOS SEED=123456</title>
    ...
    <motetype>
      ...
      <identifier>mtype_aer_tpl</identifier>
      <description>AER-MQoS node (same firmware on root and routers)</description>
    ...
    <mote>
      ...
      <motetype_identifier>mtype_aer_tpl</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
