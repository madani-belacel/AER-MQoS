...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-pdr} shows the overall and per-class C3 PDR under a lossy channel, comparing AER-MQoS against RPL-MQoS, RPL-AER, and standard RPL.
\end{figure}
...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-latency} reports the end-to-end latency under the same lossy channel, showing that AER-MQoS maintains competitive delay while improving C3 PDR.
\end{figure}
...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-jitter} depicts the per-class inter-arrival gap at the sink, confirming that AER-MQoS provides better traffic-class isolation for high-priority traffic.
\end{figure}
...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-energy} tracks the Normalized Residual Energy (NRE) over time, illustrating the energy overhead of the additional AER-MQoS context-awareness mechanisms.
\end{figure}
...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-control} compares the control-plane overhead in terms of DIO messages, showing that AER-MQoS does not incur significant additional control traffic beyond baseline RPL.
\end{figure}
...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-stability} measures route stability via parent-change frequency, demonstrating the effect of the MCS-based parent selection on network convergence.
\end{figure}
...
\begin{figure}[tp]
  ...
  \noindent Fig.~\ref{fig:eval-temporal-pdr} plots the temporal PDR evolution throughout the simulation, highlighting the convergence behaviour and steady-state performance of each protocol.
\end{figure}
